...
```bash
pip install opentrons-bioart-sim
```
...
mock = simulate_protocol('my_design.py', background='black')
```
...
- **[María José Rivas Arreola](https://pages.htgaa.org/2026a/maria-jose-rivas-arreola)** — whose HTGAA coursework inspired the creation of this standalone tool for the community.
